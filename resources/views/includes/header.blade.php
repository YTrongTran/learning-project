    ...
    <div class="flex container justify-between items-center">
        ...
        <nav class="hidden lg:flex">
            <ul class="flex gap-6 text-base font-bold transition-all">
                ...
                <li><a class="hover:text-rose-900" href="/thi-thu">Các khóa học</a></li>
                <li><a class="hover:text-rose-900" href="/thi-thu">Chúng tôi là ai</a></li>
                <li><a class="hover:text-rose-900" href="/thi-thu">Đối tác</a></li>
                <li><a class="hover:text-rose-900" href="/thi-thu">Cơ hội việc làm</a></li>
                <li><a class="hover:text-rose-900" href="/thi-thu">Chương trình online</a></li>
                <li><a class="hover:text-rose-900" href="/blog">Blog</a></li>
            </ul>
        </nav>
