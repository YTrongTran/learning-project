            ...
            <div class="absolute inset-0 flex items-center">
                <div class="relative ml-8 max-w-xl rounded-[2rem] bg-white p-8 shadow-lg">
                    ...
                    <p class="mb-6 text-gray-600">
                        Làm sao luyện thi IELTS cấp tốc trong 3 tháng thành công? Với khối lượng kiến thức học thuật khó và quỹ thời gian hẹp, các thí sinh trong giai đoạn này cần có tư duy và chiến lược đúng đắn...
                    </p>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <button class="flex items-center gap-2 rounded-full bg-red-500 px-6 py-2 text-white transition hover:bg-red-600">
                            ĐỌC THÊM
        ...
        <div class="container mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-3xl overflow-hidden shadow-lg">
                    ...
                    <div class="p-6">
                        <h3 class="text-lg font-semibold mb-2">Học tiếng Anh cho bé liệu có thực sự cần thiết cho bé giao tiếp với người nói?</h3>
                        <p class="text-gray-600 text-sm mb-4">Bạn có biết, chỉ mới 3 phút không học tiếng Anh cho bé sẽ phụ hục có thể khiến con bạn bỏng cơ hội mà bé đáng có bởi khi các bạn trẻ con thế giới...</p>
                        <button class="bg-blue-600 text-white px-4 py-2 rounded-full text-sm hover:bg-blue-700 transition-colors flex items-center gap-2">
                            Xem thêm
                ...
                <div class="bg-white rounded-3xl overflow-hidden shadow-lg">
                    ...
                    <div class="p-6">
                        <h3 class="text-lg font-semibold mb-2">Tổng hợp toàn bộ 10 vựng tiếng Anh lớp 6 Global Success, Friend Plus và Expert English</h3>
                        <p class="text-gray-600 text-sm mb-4">Khi bước vào lớp 6, việc học tiếng Anh không chỉ dừng thuần là học từ vựng mà còn là cách sử dụng các đơn vị...</p>
                        <button class="bg-blue-600 text-white px-4 py-2 rounded-full text-sm hover:bg-blue-700 transition-colors flex items-center gap-2">
                            Xem thêm
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                ...
                <div class="bg-white rounded-3xl overflow-hidden shadow-lg">
                    ...
                    <div class="p-6">
                        <h3 class="text-lg font-semibold mb-2">App học tiếng Anh cho bé: Liệu có đủ sức mạnh mê lôi học truyền thống?</h3>
                        <p class="text-gray-600 text-sm mb-4">Trước khi quyết định chọn một app học tiếng Anh cho bé, các bậc phụ huynh nên tìm hiểu kỹ những ưu và nhược điểm của từng app học...</p>
                        <button class="bg-blue-600 text-white px-4 py-2 rounded-full text-sm hover:bg-blue-700 transition-colors flex items-center gap-2">
                            Xem thêm
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
