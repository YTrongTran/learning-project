...
<div class="">
    <div class="relative w-full overflow-hidden" style="max-height: 630px;">
        <div class="relative aspect-[16/9] w-full">
            <img src="{{ asset('images/banner-blog.png') }}" alt="Students writing during exam"
                class="block md:absolute w-full h-full object-cover">
            <div class="absolute bg-gradient-to-r from-white/50 to-transparent"></div>

            <!-- Content Container -->
            <div class="container md:absolute inset-0 flex items-center">
                <div class="relative m-0 lg:ml-8 max-w-xl rounded-[2rem] bg-white p-8 shadow-lg my-4 lg:m-0">
                    <!-- Title -->
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <button
                            class="flex items-center gap-2 rounded-full bg-red-700 px-6 py-2 text-white transition hover:bg-red-900">
                            ĐỌC THÊM
    ...
    <div class="bg-section">
        <nav class="px-4 py-8">
            <div class="container mx-auto grid grid-cols-3 gap-2 md:flex flex-wrap justify-center md:gap-4 text-center">
                <a href="#"
                    class="rounded-full border shadow bg-white px-6 py-2 text-[#1e2f6f] font-medium hover:bg-rose-700 hover:text-white transition-colors justify-center flex items-center">
