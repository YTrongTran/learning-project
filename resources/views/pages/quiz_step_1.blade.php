...
<div class="bg-section">
    <div class="w-full custom-container flex flex-wrap bg-left-bottom bg-no-repeat"
        ...
        <div class="w-full md:w-1/2 bg-white shadow-lg rounded-lg p-6 md:p-10 relative">
            ...
            <form action="{{ route('quiz.step2') }}" method="POST" class="space-y-4">
                @csrf
                <div>
                ...
                <div>
                    <label for="phone" class="text-sm md:text-lg font-semibold text-[#06052E] mb-2">Số điện
                        thoại</label>
                ...
                <div class="text-center">
                    <button type="submit" class="btn-primary w-full"><span class="relative z-10">
                            Đăng ký
                        </span>
                    </button>
                </div>
