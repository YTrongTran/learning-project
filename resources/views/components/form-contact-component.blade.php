<div class="flex flex-wrap items-center">
    <div class="w-full hidden md:block md:w-2/5 justify-center relative">
        <img src="/assets/img/kid.svg" alt="Superhero Kid" class="object-contain">
    </div>

    <div class="w-full md:flex-1 bg-white shadow-lg rounded-lg p-4 md:p-6 py-10 relative">
        <h2 class="text-xl lg:text-2xl font-bold text-blue-900 uppercase mb-4">Đăng ký tư vấn</h2>

        <div class="items-center hidden md:block absolute -right-6 top-20 px-11 py-4 rounded-sm shadow-lg bg-white">
            <a href="#">
        ...
        <form action="#" method="POST" class="space-y-4 md:pr-[180px]">
            <div>
                ...
                <input type="text" id="name" name="name" placeholder="Tên" required
                    class="text-sm md:text-base w-full h-8 md:h-12 px-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400">
            </div>
            <div>
