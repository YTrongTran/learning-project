<div class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 justify-center items-center" id="modal-result-test">
    <div class="bg-white w-[800px] max-h-[90vh] rounded-lg shadow-xl overflow-y-auto p-5 z-50 relative">
        ...
        <div class="px-10 py-4 bg-gray-50 text-sm">
            ...
            <span>Time limit: {{$duration}} mins</span>
        </div>
                ...
                <table class="w-full text-sm">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left">Grade/{{$quiz['point'] ? $quiz['point']:0 }}</th>
                    ...
                    <tbody>
                        <tr class="border-t">
                            <td class="px-6 py-4">
                                <div>Finished</div>
                                <div class="text-gray-500 text-xs modal-submitted-at time-submit"></div>
                            </td>
                            <td class="px-6 py-4"><span class="modal-grade correct_count"></span></td>
        ...
        <div class="px-10 py-4 border-t">
            <p class="font-medium grade-of-total">Your final grade for this quiz is <span class="total"></span>.00</p>
        </div>
