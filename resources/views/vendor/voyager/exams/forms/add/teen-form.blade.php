    ...
    <div class="exam-teen questions-container">
            ...
            <div class="question">
                ...
                <div class="question-content">
                    <div class="form-group">
                        <input type="text" class="form-control" name="questions[teen][{{$i}}][text]" placeholder="Question">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group line-question">
                        <span class="title-choice">
                            <input type="radio"  name="questions[teen][{{$i}}][correct]" value="0">
                            A)
                        </span>
        ...
        @for ($i = 0; $i < 25; $i++)
            <div class="question">
                ...
                <div class="question-content">
                    <div class="form-group">
                        <input type="text" class="form-control" name="questions[teen][{{$i+25}}][text]" placeholder="Question">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group line-question">
                        <span class="title-choice">
                            <input type="radio"  name="questions[teen][{{$i+25}}][correct]" value="0">
                            A)
                        </span>
