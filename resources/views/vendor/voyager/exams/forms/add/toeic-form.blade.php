        ...
        @for ($i = 0; $i < 25; $i++)
            <div class="question">
                ...
                <div class="question-content">
                    ...
                    <div class="form-group line-question">
                        <span class="title-choice">
                            <input type="radio" name="questions[toeic][{{$i}}][correct]" value="4">
                            D)
                        </span>
                        <input type="text" class="form-control" name="questions[toeic][{{$i}}][answers][]" placeholder="Answer" required>
                    </div>
                    <div class="form-group">
                        ...
                        @php
                            $rowMediaType = (object)[
                                "field" => "questions[toeic][$i][image]",
                                "field_id" => "questions-toeic-$i-image",
                                "value" => "",
                                'slug'=>'exams/Images',
                                "type" => "media_picker", 
                                "display_name" => "Image", 
                    ...
                    <div class="form-group">
                        ...
                        @php
                            $rowMediaType = (object)[
                                "field" => "questions[toeic][$i][sound]",
                                "field_id" => "questions-toeic-$i-sound",
                                "value" => "",
                                'slug'=>'exams/Sounds',
                                "type" => "media_picker", 
                                "display_name" => "Sound", 
        ...
        @for ($i = 0; $i < 25; $i++)
            <div class="question">
                ...
                <div class="question-content">
                    ...
                    <div class="form-group line-question">
                        <span class="title-choice">
                            <input type="radio" name="questions[toeic][{{$i+25}}][correct]" value="4">
                            D)
                        </span>
                        <input type="text"  class="form-control" name="questions[toeic][{{$i+25}}][answers][]" placeholder="Answer" required>
                    </div>
                    <div class="form-group">
                        ...
                        @php
                            $j = $i + 25;
                            $rowMediaType = (object)[
                                "field" => "questions[toeic][$j][image]",
                                "field_id" => "questions-toeic-$j-image",
                                "value" => "",
                                'slug'=>'exams/Images',
                                "type" => "media_picker", 
                                "display_name" => "Image", 
                    ...
                    <div class="form-group">
                        ...
                        @php
                            $j = $i + 25;
                            $rowMediaType = (object)[
                                "field" => "questions[toeic][$j][sound]",
                                "field_id" => "questions-toeic-$j-sound",
                                "value" => "",
                                'slug'=>'exams/Sounds',
                                "type" => "media_picker", 
                                "display_name" => "Sound", 
